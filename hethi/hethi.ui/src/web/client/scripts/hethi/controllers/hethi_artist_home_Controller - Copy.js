...
$scope.loadMxsd('http://localhost:4141/images/ixsd/mxsd.xml');
...
$scope.loadMasterForm=function(path){
    ...
    $scope.loadMasterFormStart=function(){
        $scope.loadMasterForm('http://localhost:4141/images/ixsd/po.xml');
    };
    ...
    $scope.formPlay_2=function(data){
        ...
        $scope.hethi_artist_home="viewStecil";//viewForms
    };
                        ...
                        $http({
                            ...
                            if($scope.efs_data_header.length>0){
                                ...
                                $scope.efs_data_header.forEach(function(f){
                                    ...
                                    formNo.efsuin.header.field.forEach(function(fun1){
                            ...
                            if($scope.efs_data_footer.length>0){
                                ...
                                $scope.efs_data_footer.forEach(function(f){
                                    ...
                                    formNo.efsuin.footer.field.forEach(function(fun1){
                                        if(fun1.ixsdfieldname== f.ixsdfieldname){
                                            var positionInput={
                                                top:f.data.position.top,
                                                left:f.data.position.left,
    ...
    $scope.addTomxsd=function(selectedValue){
        if(selectedValue.position){
            selectedValue.position.top= $('#x1').val();
            selectedValue.position.left=$('#y1').val();
            selectedValue.position.width=$('#w').val();
            selectedValue.position.height=$('#h').val();
        }
        var a='';
