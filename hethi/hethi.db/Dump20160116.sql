...
INSERT INTO `cruleworkset` VALUES ('ws1001','DaaSclassifyValidation','import ipost description','1','2016-01-15 17:21:31','pk1001',2),('ws1003','DaaSclassifyValidation1','Custom rule DaaSclassifyValidation1','1','2016-01-15 17:21:31','pk1001',3),('ws1004','DAAS','Custom rule ','1','2016-01-15 17:21:31','pk1001',1),('ws1005','DaaSclassifyValidation','import ipost description','1','2016-01-01 17:28:29','pk1002',NULL),('ws1006','DaaSclassifyValidation1','Custom rule DaaSclassifyValidation1','1','2016-01-01 17:28:29','pk1002',NULL),('ws1007','DAAS','Custom rule ','1','2016-01-01 17:28:29','pk1002',NULL),('ws1008','','Custom rule ','1','2016-01-06 17:44:35',NULL,NULL),('ws1009','','Custom rule ','1','2016-01-06 17:44:57',NULL,NULL),('ws1010','','Custom rule ','1','2016-01-06 17:45:05',NULL,NULL),('ws1011','','Custom rule ','1','2016-01-06 17:45:41',NULL,NULL),('ws1012','','Custom rule ','1','2016-01-10 13:14:20',NULL,NULL),('ws1013','','Custom rule ','1','2016-01-10 13:18:28',NULL,NULL),('ws1014','','Custom rule ','1','2016-01-10 13:23:40',NULL,NULL),('ws1015','','Custom rule ','1','2016-01-10 16:43:55',NULL,NULL),('ws1016','','Custom rule ','1','2016-01-10 16:57:06',NULL,NULL),('ws1017','','Custom rule ','1','2016-01-10 17:16:36',NULL,NULL),('ws1018','','Custom rule ','1','2016-01-12 11:10:18',NULL,NULL),('ws1019','','Custom rule ','1','2016-01-12 11:13:20',NULL,NULL),('ws1020','','Custom rule ','1','2016-01-12 11:31:54',NULL,NULL),('ws1021','','Custom rule ','1','2016-01-12 11:32:33',NULL,NULL),('ws1022','','Custom rule ','1','2016-01-12 11:35:32',NULL,NULL),('ws1023','','Custom rule ','1','2016-01-12 11:42:04',NULL,NULL),('ws1024','','Custom rule ','1','2016-01-12 11:54:32',NULL,NULL),('ws1025','','Custom rule ','1','2016-01-12 13:38:34',NULL,NULL),('ws1026','','Custom rule ','1','2016-01-12 16:18:34',NULL,NULL);
...
INSERT INTO `dassign_customer_serviceplay` VALUES (1,'csfs10000','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100101','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100102','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100103','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100104','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100105','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100106','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100107','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100108','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100109','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100140','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100142','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100143','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100145','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100146','cefs100101','1','2016-01-15 17:21:12'),(1,'csfs100147','cefs100101','1','2016-01-15 17:21:12');
...
INSERT INTO `rule_operators` VALUES (1,'=','Boolean','op'),(1,'==','Date','op'),(1,'+','Decimal','op'),(1,'in','Integer','fun'),(1,'toUpper','String','fun'),(2,'<>','Boolean','op'),(2,'<','Date','op'),(2,'-','Decimal','op'),(2,'absVal','Integer','fun'),(2,'toLower','String','fun'),(3,'and','Boolean','op'),(3,'>','Date','op'),(3,'*','Decimal','op'),(3,'toDecimal','Integer','fun'),(3,'contains(paramString','String','fun(parm)'),(4,'or','Boolean','op'),(4,'<>','Date','op'),(4,'/','Decimal','op'),(4,'toString','Integer','fun'),(4,'charsIn(validSet)','String','fun(parm)'),(5,'~','Boolean','op'),(5,'>=','Date','op'),(5,'=','Decimal','op'),(5,'=','Integer','op'),(5,'equals','String','fun(parm)'),(6,'<=','Date','op'),(6,'<>','Decimal','op'),(6,'<>','Integer','op'),(6,'=','String','op'),(7,'in','Date','op'),(7,'<','Decimal','op'),(7,'<','Integer','op'),(7,'<>','String','op'),(8,'year','Date','fun'),(8,'<=','Decimal','op'),(8,'<=','Integer','op'),(8,'<','String','op'),(9,'month','Date','fun'),(9,'>','Decimal','op'),(9,'>','Integer','op'),(9,'<=','String','op'),(10,'day','Date','fun'),(10,'>=','Decimal','op'),(10,'>=','Integer','op'),(10,'>','String','op'),(11,'addYears','Date','fun(parm)'),(11,'**','Decimal','op'),(11,'+','Integer','op'),(11,'>=','String','op'),(12,'addMonths','Date','fun(parm)'),(12,'+=','Decimal','op'),(12,'-','Integer','op'),(12,'+','String','op'),(13,'addDays','Date','fun(parm)'),(13,'-=','Decimal','op'),(13,'*','Integer','op'),(13,'in','String','op'),(14,'yearsBetween','Date','fun(parm)'),(14,'in','Decimal','op'),(14,'/','Integer','op'),(14,'size','String','fun'),(15,'monthsBetween','Date','fun(parm)'),(15,'absVal','Decimal','fun'),(15,'+=','Integer','op'),(15,'concat','String','fun(parm)'),(16,'daysBetween','Date','fun(parm)'),(16,'round','Decimal','fun'),(16,'-=','Integer','op'),(16,'toDecimal','String','fun'),(17,'dayOfWeek','Date','fun'),(17,'floor','Decimal','fun'),(17,'max','Integer','fun(parm)'),(17,'toDateTime','String','fun'),(18,'weekOfYear','Date','fun'),(18,'round(parm)','Decimal','fun(parm)'),(18,'min','Integer','fun(parm)'),(18,'toInteger','String','fun'),(19,'dayOfYear','Date','fun'),(19,'toIntger','Decimal','fun'),(19,'div','Integer','fun(parm)'),(19,'substring','String','fun(parm)'),(20,'weekOfMonth','Date','fun'),(20,'toString','Decimal','fun'),(20,'mod','Integer','fun(parm)'),(20,'indexOf','String','fun(parm)'),(21,'toDateTime','Date','fun'),(21,'max','Decimal','fun(parm)'),(21,'log','Integer','fun'),(21,'equalsIgnoreCase','String','fun(parm)'),(22,'toDateTime','Date','fun(parm)'),(22,'min','Decimal','fun(parm)'),(22,'log(logBase)','Integer','fun(parm)'),(22,'startsWith','String','fun(parm)'),(23,'toString','Date','fun'),(23,'log','Decimal','fun'),(23,'In','Integer','fun'),(23,'endsWith','String','fun(parm)'),(24,'nextDay','Date','fun'),(24,'log(logBase)','Decimal','fun(parm)'),(24,'isProbabePrime','Integer','fun(parm)'),(24,'containsBlanks','String','fun(parm)'),(25,'getMilliseconds','Date','fun'),(25,'In','Decimal','fun'),(25,'gcd','Integer','fun(parm)'),(25,'characterAt','String','fun(parm)'),(26,'truncate','Decimal','fun'),(26,'negate','Integer','fun'),(26,'isInteger','String','fun'),(27,'fraction','Decimal','fun'),(27,'trimSpaces','String','fun'),(28,'movePoint','Decimal','fun(parm)'),(28,'charsIn','String','fun(parm)');
...
INSERT INTO `dupload_status` VALUES (1,1,3,3,'2016-01-15 16:22:03'),(10,1,3,3,'2016-01-15 16:19:33'),(11,1,2,1,'2016-01-15 17:21:12'),(13,1,3,3,'2016-01-15 17:14:13');
...
INSERT INTO `customer_flow` VALUES (1,'cefs100101','{\"class\":\"go.GraphLinksModel\",\"nodeDataArray\":[{\"category\":\"Rectangledaas\",\"text\":\"daas.inventory\",\"key\":\"csfs100101\",\"demokey\":\"csfs100101\",\"loc\":\"-452.96102834302314 -428.52558139534875\"},{\"category\":\"Start\",\"text\":\"Start\",\"key\":\"Start\",\"loc\":\"-558.9610283430229 -343.5255813953488\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.fullextract\",\"key\":\"csfs100102\",\"demokey\":\"csfs100102\",\"loc\":\"-303.96102834302314 -410.52558139534864\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.classify\",\"key\":\"csfs100103\",\"demokey\":\"csfs100103\",\"loc\":\"-150.96102834302275 -395.5255813953487\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.index\",\"key\":\"csfs100104\",\"demokey\":\"csfs100104\",\"loc\":\"-17.96102834302289 -374.525581395349\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.split_merge\",\"key\":\"csfs100105\",\"demokey\":\"csfs100105\",\"loc\":\"148.03897165697708 -422.52558139534864\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.extract\",\"key\":\"csfs100106\",\"demokey\":\"csfs100106\",\"loc\":\"312.03897165697697 -383.52558139534875\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.batch\",\"key\":\"csfs100107\",\"demokey\":\"csfs100107\",\"loc\":\"258.0389716569768 -280.5255813953488\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.keywise\",\"key\":\"csfs100108\",\"demokey\":\"csfs100108\",\"loc\":\"382.71084665697686 -232.7348837209302\"},{\"category\":\"Rectangledaas\",\"text\":\"daas.baashandoff\",\"key\":\"csfs100109\",\"demokey\":\"csfs100109\",\"loc\":\"363.7108466569771 -95.73488372093021\"},{\"category\":\"Rectanglebaas\",\"text\":\"baas.workflow\",\"key\":\"csfs100120\",\"demokey\":\"csfs100120\",\"loc\":\"191.00154433139573 -117.73488372093021\"},{\"category\":\"Rectanglebaas\",\"text\":\"baas.reject\",\"key\":\"csfs100121\",\"demokey\":\"csfs100121\",\"loc\":\"49.001544331395735 -140.7348837209302\"},{\"category\":\"Rectangleoaas\",\"text\":\"oaas.output\",\"key\":\"csfs100140\",\"demokey\":\"csfs100140\",\"loc\":\"-81.99845566860427 -182.7348837209302\"},{\"category\":\"Rectangleoaas\",\"text\":\"oaas.rejects\",\"key\":\"csfs100142\",\"demokey\":\"csfs100142\",\"loc\":\"-210.99845566860427 -203.7348837209302\"},{\"category\":\"Rectangleoaas\",\"text\":\"oaas.hml\",\"key\":\"csfs100143\",\"demokey\":\"csfs100143\",\"loc\":\"-327.99845566860427 -236.7348837209302\"},{\"category\":\"Rectangleoaas\",\"text\":\"oaas.shipment\",\"key\":\"csfs100141\",\"demokey\":\"csfs100141\",\"loc\":\"-478.99845566860427 -199.7348837209302\"},{\"category\":\"Rectangleaaas\",\"text\":\"exit_channel\",\"key\":\"csfs10000\",\"demokey\":\"csfs10000\",\"loc\":\"-432.99845566860427 -109.73488372093021\"},{\"category\":\"End\",\"text\":\"End\",\"key\":\"End\",\"loc\":\"-251.99845566860427 -99.73488372093021\"}],\"linkDataArray\":[{\"from\":\"Start\",\"to\":\"csfs100101\"},{\"from\":\"csfs100101\",\"to\":\"csfs100102\"},{\"from\":\"csfs100102\",\"to\":\"csfs100103\"},{\"from\":\"csfs100103\",\"to\":\"csfs100104\"},{\"from\":\"csfs100104\",\"to\":\"csfs100105\"},{\"from\":\"csfs100105\",\"to\":\"csfs100106\"},{\"from\":\"csfs100106\",\"to\":\"csfs100107\"},{\"from\":\"csfs100107\",\"to\":\"csfs100108\"},{\"from\":\"csfs100108\",\"to\":\"csfs100109\"},{\"from\":\"csfs100109\",\"to\":\"csfs100120\"},{\"from\":\"csfs100120\",\"to\":\"csfs100121\"},{\"from\":\"csfs100121\",\"to\":\"csfs100140\"},{\"from\":\"csfs100140\",\"to\":\"csfs100142\"},{\"from\":\"csfs100142\",\"to\":\"csfs100143\"},{\"from\":\"csfs100143\",\"to\":\"csfs100141\"},{\"from\":\"csfs100141\",\"to\":\"csfs10000\"},{\"from\":\"csfs10000\",\"to\":\"End\"}]}');
...
INSERT INTO `ixsd_cefs100101` VALUES ('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('1','1',1,'cefs100101','hjh','','','','','currency','2016-01-07 16:01:30','','','','','','','','0','2016-01-07 16:01:30','0','0','2016-01-07 16:01:30','2016-01-07 16:01:30','3','','','','','','','Route to Storage Repository','','','2016-01-07 16:01:30','','','','','','','','','','','','2016-01-07 16:01:30','2016-01-07 16:01:30','fg'),('10','1',1,'cefs100101','\r\n','','','','','','2016-01-15 16:19:58','','','','','','','','','2016-01-15 16:19:58','','','2016-01-15 16:19:58','2016-01-15 16:19:58','','','','','','','','','','','2016-01-15 16:19:58','','','','','','','','','','','','2016-01-15 16:19:58','2016-01-15 16:19:58',''),('10','1',1,'cefs100101',NULL,'','','','','','2016-01-15 16:22:15','','','','','','','','','2016-01-15 16:22:15','','','2016-01-15 16:22:15','2016-01-15 16:22:15','','','','','','','','','','','2016-01-15 16:22:15','','','','','','','','','','','','2016-01-15 16:22:15','2016-01-15 16:22:15','');
...
INSERT INTO `dupload_file` VALUES (1,1,'apple_mac1452849724567.pdf','pdf','http://localhost:2687/images/uploads/apple_mac1452849724567.jpg',171769,0,'cefs100101',3,'2016-01-15 12:22:05',3),(10,1,'invoice_31452863712014.jpg','jpg','http://localhost:5050/images/uploads/invoice_31452863712014.jpg',130504,0,'cefs100101',3,'2016-01-15 16:15:15',2),(11,1,'Example_002_A4.jpg','jpg','http://localhost:2687/images/email/Example_002_A4.jpg',171198,3,'cefs100101',1,'2016-01-15 16:25:24',2),(13,1,'Example_002_A41452867246874.jpg','jpg','http://localhost:2687/images/uploads/Example_002_A41452867246874.jpg',125104,3,'cefs100101',3,'2016-01-15 17:14:13',2);
...
CREATE TABLE `dcustomer_output` (
  ...
  `lastupuser` char(6) NOT NULL COMMENT 'user ID audit trail',
  `lastupdtm` datetime NOT NULL COMMENT 'auto fill server date and time zone',
  PRIMARY KEY (`customer_id`,`tfs_uin`,`efs_uin`,`uid`,`din`,`version`,`lastupdtm`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dcustomer_upload` VALUES (1,1,2,'2016-01-15 12:22:50','1','2016-01-15 12:22:04'),(1,2,NULL,'2016-01-15 15:36:16','1','2016-01-15 15:36:16'),(1,3,NULL,'2016-01-15 15:44:48','1','2016-01-15 15:44:48'),(1,4,NULL,'2016-01-15 15:47:35','1','2016-01-15 15:47:35'),(1,5,NULL,'2016-01-15 15:49:11','1','2016-01-15 15:49:11'),(1,6,NULL,'2016-01-15 15:56:56','1','2016-01-15 15:56:56'),(1,7,NULL,'2016-01-15 16:00:04','1','2016-01-15 16:00:04'),(1,8,NULL,'2016-01-15 16:09:52','1','2016-01-15 16:09:52'),(1,9,NULL,'2016-01-15 16:11:19','1','2016-01-15 16:11:19'),(1,10,2,'2016-01-15 16:16:32','1','2016-01-15 16:15:12'),(1,11,2,'2016-01-15 17:21:12','1','2016-01-15 16:25:17'),(1,12,NULL,'2016-01-15 16:31:04','1','2016-01-15 16:31:04'),(1,13,NULL,'2016-01-15 17:14:06','1','2016-01-15 17:14:06');
...
INSERT INTO `ixsd_cefs100101_lineitem` VALUES ('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('2','2','cefs100101',1,'2015-10-11 10:10:10',1,'part descr','530','po line item','55','4','87','87','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0'),('1','1','cefs100101',1,'2015-10-10 10:10:10',1,'part descr','540','po line item','54','4','87','78','po pool','8','0');
...
INSERT INTO `dcustomrules` VALUES (1,'','cefs100101','qs1001','rule100119',2,'form:ixsd_cefs100101(invoice_number== &amp;quot;0&amp;quot; ))','ixsd_ixsd_cefs100101.setInvoice_number(cefs100101.getDepartment_code)','No Exception','ws1001','1','2016-01-15 17:21:31','rs1002','Rule 1',2,NULL),(1,'csfs100140','cefs100101','qs1001','rule100119',1,'form:ixsd_cefs100101(invoice_amount== &amp;quot;0&amp;quot; ) and  ip:iPost()','form.setQueue(&amp;quot;Route to Storage Repository&amp;quot;); ip.stackDescription(&amp;quot;document Route to Storage Repository&amp;quot;);  ip.setNext_channel(&amp;quot;exit_channel&amp;quot;);','INVOICE TOTAL=0;','ws1001','1','2016-01-15 17:21:31','rs1002','Rule 1',1,NULL);
...
INSERT INTO `cruleset` VALUES ('rs1002','pk1001','ws1001','Ruleset 1','Ruleset desc','1','2016-01-15 17:21:31',1,NULL,NULL);
...
INSERT INTO `dupload_status_history` VALUES (1,1,0,3,'2016-01-15 12:22:05'),(1,1,1,1,'2016-01-15 12:22:50'),(10,1,0,3,'2016-01-15 16:15:15'),(10,1,1,1,'2016-01-15 16:16:32'),(10,1,3,3,'2016-01-15 16:19:33'),(1,1,3,3,'2016-01-15 16:22:03'),(11,1,3,1,'2016-01-15 16:25:24'),(13,1,3,3,'2016-01-15 17:14:13'),(11,1,1,1,'2016-01-15 17:21:12');
...
INSERT INTO `cindexclassifystencil` VALUES (1,'1','cefs100101','{\"efsuin\":{\"header\":{\"position\":{\"top\":\"\",\"left\":\"\",\"width\":\"\",\"height\":\"\"},\"field\":[{\"name\":\"\",\"ixsdfieldname\":\"branch_location\",\"value\":\"\",\"label\":{\"content\":\"\",\"position\":{\"top\":\"\",\"left\":\"\",\"width\":\"\",\"height\":\"\"},\"classify\":{\"toreject\":\"\",\"tosplit\":\"\",\"tomerge\":\"\",\"tomXSD\":\"\"}},\"data\":{\"content\":\"\",\"position\":{\"top\":\"\",\"left\":\"\",\"width\":\"\",\"height\":\"\"},\"classify\":{\"toreject\":\"\",\"tosplit\":\"\",\"tomerge\":\"\",\"tomXSD\":\"\"}}}],\"show\":true},\"footer\":{\"position\":{\"top\":\"\",\"left\":\"\",\"width\":\"\",\"height\":\"\"},\"field\":[]},\"body\":{\"table\":{\"header\":{\"field\":[]},\"lineitem\":{\"field\":[]},\"footer\":{\"field\":[]}},\"field\":[]}}}','','2','2016-01-15 16:21:04'),(2,'3','cefs100101','<efsuin><header><position><top></top><left></left><width></width><height></height></position><field><name></name><ixsdfieldname>branch_location</ixsdfieldname><value></value><label><content></content><position><top>168</top><left>96</left><width>189</width><height>42</height></position><classify><toreject></toreject><tosplit></tosplit><tomerge></tomerge><tomXSD></tomXSD></classify><show>true</show></label><data><content></content><position><top>552</top><left>143</left><width>265</width><height>44</height></position><classify><toreject></toreject><tosplit></tosplit><tomerge></tomerge><tomXSD></tomXSD></classify><show>true</show></data><show>true</show></field><show>true</show></header><footer><position><top></top><left></left><width></width><height></height></position><field/></footer><body><table><header><field/></header><lineitem><field/></lineitem><footer><field/></footer></table><field/></body></efsuin>','http://localhost:5050/images/ixsd/10_1_3.xml','3','2016-01-15 16:19:33'),(3,'3','cefs100101','<efsuin><header><position><top></top><left></left><width></width><height></height></position><field><name></name><ixsdfieldname>branch_location</ixsdfieldname><value></value><label><content></content><position><top>65</top><left>25</left><width>314</width><height>86</height></position><classify><toreject></toreject><tosplit></tosplit><tomerge></tomerge><tomXSD></tomXSD></classify><show>true</show></label><data><content></content><position><top>393</top><left>13</left><width>433</width><height>64</height></position><classify><toreject></toreject><tosplit></tosplit><tomerge></tomerge><tomXSD></tomXSD></classify><show>true</show></data><show>true</show></field><show>true</show></header><footer><position><top></top><left></left><width></width><height></height></position><field/></footer><body><table><header><field/></header><lineitem><field/></lineitem><footer><field/></footer></table><field/></body></efsuin>','http://localhost:5050/images/ixsd/1_1_3.xml','3','2016-01-15 16:22:03');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `add_new_rules_for_sfs`(in varcustomer_id int,in varuser_id int,in vartfs_uin char(10),in varefs_uin char(10),in varsfs_uin char(10),in varrule_workset char(20))
BEGIN

declare current_status bigint default 0;

set current_status= ( select ifnull((select hethi.dcustomrules.customer_id  From  hethi.dcustomrules where  hethi.dcustomrules.customer_id=varcustomer_id and hethi.dcustomrules.efs_uin=varefs_uin and hethi.dcustomrules.sfs_uin=varsfs_uin and  hethi.dcustomrules.rule_workset=varrule_workset limit 1),0));
...
`dcustomrules`.`rule_type`
from
`hethi`.`dcustomrules`
where
 hethi.dcustomrules.rule_workset=varrule_workset and 
 hethi.dcustomrules.sfs_uin in("",null)limit 1

);

else

select 'no data' as da;
...
where 
hethi.dcustomrules.sfs_uin in("",null);
...
in efsuin varchar(10),in ruleAction varchar(250),
in ruleCondition varchar(250),in ruleException varchar(100),
 in ruleName varchar(100),in ruleWorkset varchar(10),
in rulesetId varchar(10),in ruleType int(11))
BEGIN
declare ruleOrder int(11);
declare zoneId int(11);
set ruleOrder=(select ifnull((select max(`dcustomrules`.`rule_order`) from `hethi`.`dcustomrules`),0));
set ruleOrder=ruleOrder+1;
set zoneId=(select ifnull((select max(`dcustomrules`.`zone_id`) from `hethi`.`dcustomrules`),0));
set zoneId=zoneId+1;
INSERT INTO `hethi`.`dcustomrules`
(`customer_id`,
`efs_uin`,
...
-- Dump completed on 2016-01-16 10:26:41
